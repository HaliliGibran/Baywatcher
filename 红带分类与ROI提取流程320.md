...
标识块回归函数
f_marker(x,y) = 1.449967*x + 7.109515*y - 739.671000

路障回归函数

f_roadblock(x,y) = 2.187043*x + 55.863983*y - 4018.754549
...
化简后固定为：
f_threshold(x,y) = 1.818505*x + 31.486749*y - 2379.212775
