...
void BayWatcher_Menu::show() {
    ...
    switch(menu_num) {
        ...
        case 1: // ================= 监控页 =================
            ...
            sprintf(buf, "%sVOFA Rem:%d", highlight_num == 2 ? "> ":"  ", cfg_vofa_remote_enable ? 1 : 0);
            ...
            if(highlight_num == 3) TFTSPI_dir_P8X16Str(0, 6, "> BACK", u16YELLOW, u16BLACK);
    ...
    switch(Key) {
                ...
                switch(menu_num) {
                    ...
                    case 1: // 监控页跳转逻辑
                        if(highlight_num == 1) { 
                            ...
                            write_ena = 1;
                            write_pointer_b = &cfg_vofa_remote_enable;
                            write_pointer = NULL;
                        }
                        else if(highlight_num == 3) { 
                            menu_num = 0; 
        ...
        case KeyOp::Down: 
            if(write_ena == 1) {
                ...
                else if(menu_num == 1) max_items = 3; 
