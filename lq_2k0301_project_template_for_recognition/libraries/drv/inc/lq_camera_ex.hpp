...
public:
     ...
     * @return  成功返回true, 否则返回false.
     ********************************************************************************/
    bool set_gain_manual(double gain);

    /********************************************************************************
     * @brief   设置摄像头的手动白平衡.
     * @param   blue_u : 蓝通道白平衡参数.
     * @param   red_v  : 红通道白平衡参数.
     * @return  成功返回true, 否则返回false.
     ********************************************************************************/
    bool set_white_balance_manual(double blue_u, double red_v);

    /********************************************************************************
     * @brief   设置摄像头为自动白平衡.
     * @return  成功返回true, 否则返回false.
     ********************************************************************************/
    bool set_white_balance_auto();

    /********************************************************************************
     * @brief   读取当前曝光值.
     * @return  成功返回当前曝光值, 失败返回0.
     ********************************************************************************/
    double get_exposure_value() const;

    /********************************************************************************
     * @brief   读取当前增益值.
     * @return  成功返回当前增益值, 失败返回0.
     ********************************************************************************/
    double get_gain_value() const;

    /********************************************************************************
     * @brief   读取当前蓝通道白平衡参数.
     * @return  成功返回当前参数值, 失败返回0.
     ********************************************************************************/
    double get_white_balance_blue_u_value() const;

    /********************************************************************************
     * @brief   读取当前红通道白平衡参数.
     * @return  成功返回当前参数值, 失败返回0.
     ********************************************************************************/
    double get_white_balance_red_v_value() const;
